              ...
              children: <Widget>[
                ...
                new Row(
                  children: <Widget>[
                    new Container(
                      child: new Chip(
                        label: new FlatButton(onPressed: (){}, child: new Text("新冠肺炎疫情",style: new TextStyle(color: GlobalConfig.fontColor),)),
                    ...
                    new Container(
                      child: new Chip(
                        label: new FlatButton(onPressed: (){}, child: new Text("",style: new TextStyle(color: GlobalConfig.fontColor))),
                        backgroundColor: GlobalConfig.dark == true ? Colors.white10 : Colors.black12,
                      ),
                      margin: const EdgeInsets.only(left: 16.0, bottom: 16.0),
                      alignment: Alignment.topLeft,
