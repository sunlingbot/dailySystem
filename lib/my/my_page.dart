                  ...
                  child: new FlatButton (
                      ...
                      child: new Container(
                        ...
                        child: new Column(
                          children: <Widget>[
                            new Container(
                              child: new Text("1", style: new TextStyle(fontSize: 16.0, color: GlobalConfig.fontColor),),
                            ),
                            new Container(
                  ...
                  child: new FlatButton(
                      ...
                      child: new Container(
                        ...
                        child: new Column(
                          children: <Widget>[
                            new Container(
                              child: new Text("36", style: new TextStyle(fontSize: 16.0, color: GlobalConfig.fontColor),),
                            ),
                            new Container(
                    ...
                    child: new FlatButton(
                        ...
                        child: new Container(
                          ...
                          child: new Column(
                            children: <Widget>[
                              new Container(
                                child: new Text("10", style: new TextStyle(fontSize: 16.0, color: GlobalConfig.fontColor),),
                              ),
                              new Container(
                ...
                child: new Row(
                  children: <Widget>[
                    ...
                    new Container(
                      child: new FlatButton(
                          onPressed: (){},
                          child: new Text("热门", style: new TextStyle(color: Colors.blue),)
                      ),
                    )
                  ],
                )
                              ...
                              child: new Column(
                                children: <Widget>[
                                  new Align(
                                    ...
                                    child: new Container(
                                      child: new Text("中国防控措施成功打破了病毒传播链！", style: new TextStyle(color: GlobalConfig.dark == true? Colors.white70 : Colors.black, fontSize: 16.0),),
                                    ),
                                  ),
                                  new Align(
                                      alignment: Alignment.centerLeft,
                                      child: new Container(
                                        ...
                                        child: new Text("全国抗疫，刻不容缓", style: new TextStyle(color: GlobalConfig.fontColor),),
                                      )
                                  )
                              ...
                              child: new Column(
                                children: <Widget>[
                                  new Align(
                                    alignment: Alignment.centerLeft,
                                    child: new Container(
                                      child: new Text("iOS13.5正式发布", style: new TextStyle(color: GlobalConfig.dark == true? Colors.white70 : Colors.black, fontSize: 16.0),),
                                    ),
                                  ),
                                  new Align(
                                      alignment: Alignment.centerLeft,
                                      child: new Container(
                                        margin: const EdgeInsets.only(top: 6.0),
                                        child: new Text("HPV疫苗", style: new TextStyle(color: GlobalConfig.fontColor),),
                                      )
                                  )
